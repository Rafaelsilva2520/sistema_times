...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // stmt e a variavel que guarda uma comnsulta prepara no bd IMPORTANTE
    // mensagem de sucesso
    echo "<p style='color:green;'>Time cadastrado com sucesso!</p>";

    echo '<a href="cadastrar_time.php">Cadastrar outro</a><br>';
    echo '<a href="listar_times.php">Listar times</a>';
}